...
# To get min , max , sum(only for list of numbers) simply use the functions (based on sorting)
print(max(courses)) # this will print the last element after sort in the list of strings
